...
library(tidymodels)
library(vip)
credit_final_lr_model <- read_rds("../credit_final_lr_model.rds")
credit_lr_last_fit <- read_rds("../credit_lr_last_fit.rds")
credit_lr_last_fit_model <- read_rds("../credit_lr_last_fit_model.rds")
